// Database seeding script for Ministry of Altar Servers (Fixed Types)
// Run with: npx tsx scripts/seed-ministry.ts
  ...
  try {
    ...
    for (const memberData of sampleMembers) {
      ...
      if (!existingMember) {
        ...
        console.log(`✅ Created member: ${memberData.name} (${memberData.memberId})`);
      } else {
    ...
    // 5. Create Sample Notifications (Fixed with proper enum types)
